...
THUMB UnkStruct_0203dae0::UnkStruct_0203dae0(u8 param1) {
    ...
    if (this->mUnk_121 == 0) {
        this->mUnk_114 = new(data_027e0ce0[1], 4) UnkStruct_0203d1d0();
    } else {
        this->mUnk_114 = new(data_027e0ce0[1], 4) UnkStruct_0203d254();
    }
}
...
ARM void UnkStruct_0203dae0::func_0203dc10(unk32 param_2) {
    if (param_2 != 0) {
...
ARM void UnkStruct_0203dae0::func_0203dcfc(u8 param1, unk32 param2, unk32 param3, s32 param4) {
    ...
    this->mUnk_11c = UnkStruct_0203dae0::func_0203d318(this->mUnk_14, this->mUnk_18);
    this->func_0203dc10(1);

    if (func_0203d400(this->UnkStruct_02032f0c::func_02032fa4()) != 0) {
        func_020298b8(&this->mUnk_10, this->func_0203ddec(), this->mUnk_14, this->mUnk_18, 4);
    } else {
        func_02029830(&this->mUnk_10, this->func_0203ddec(), this->mUnk_14, this->mUnk_18, 4);
    }

    this->mUnk_28 = (unk32 *) this->mUnk_2c;
    this->mUnk_2c = &(UnkStruct_MsgProc_Base_unk_2C *) this->mUnk_10;
    this->mUnk_30 = param4;
    this->mUnk_34 = 3;
...
ARM unk32 UnkStruct_0203dae0::func_0203de14(unk32 param1) {
    //! TODO: class?
