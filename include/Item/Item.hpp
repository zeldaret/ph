...
enum ItemFlag_ {
    ItemFlag_None                     = -1,
    /* 0x00 */ ItemFlag_OshusSword    = FLAG(FlagIndex_0, FlagSlot_0),
    /* 0x01 */ ItemFlag_WoodenShield  = FLAG(FlagIndex_0, FlagSlot_1),
    /* 0x02 */ ItemFlag_Boomerang     = FLAG(FlagIndex_0, FlagSlot_2),
    /* 0x03 */ ItemFlag_Shovel        = FLAG(FlagIndex_0, FlagSlot_3),
    /* 0x04 */ ItemFlag_BombBag       = FLAG(FlagIndex_0, FlagSlot_4),
    /* 0x05 */ ItemFlag_Bow           = FLAG(FlagIndex_0, FlagSlot_5),
    /* 0x06 */ ItemFlag_GrapplingHook = FLAG(FlagIndex_0, FlagSlot_6),
    /* 0x07 */ ItemFlag_BombchuBag    = FLAG(FlagIndex_0, FlagSlot_7),
    /* 0x08 */ ItemFlag_Hammer        = FLAG(FlagIndex_0, FlagSlot_8),
    /* 0x09 */ ItemFlag_PotionA       = FLAG(FlagIndex_0, FlagSlot_9),
    /* 0x0a */ ItemFlag_PotionB       = FLAG(FlagIndex_0, FlagSlot_10),
    ...
    /* 0x14 */ ItemFlag_SpiritOfCourage = FLAG(FlagIndex_0, FlagSlot_20),
    /* 0x15 */ ItemFlag_SpiritOfPower   = FLAG(FlagIndex_0, FlagSlot_21),
    /* 0x16 */ ItemFlag_SpiritOfWisdom  = FLAG(FlagIndex_0, FlagSlot_22),
    /* 0x17 */ ItemFlag_CourageLv1      = FLAG(FlagIndex_0, FlagSlot_23),
    /* 0x18 */ ItemFlag_PowerLv1        = FLAG(FlagIndex_0, FlagSlot_24),
    /* 0x19 */ ItemFlag_WisdomLv1       = FLAG(FlagIndex_0, FlagSlot_25),
    ItemFlag_FAIRY_LV1                  = ItemFlag_CourageLv1,
    /* 0x1a */ ItemFlag_CourageLv2      = FLAG(FlagIndex_0, FlagSlot_26),
    /* 0x1b */ ItemFlag_PowerLv2        = FLAG(FlagIndex_0, FlagSlot_27),
    /* 0x1c */ ItemFlag_WisdomLv2       = FLAG(FlagIndex_0, FlagSlot_28),
    ItemFlag_FAIRY_LV2                  = ItemFlag_CourageLv2,

    /* 0x20 */ ItemFlag_Hourglass    = FLAG(FlagIndex_1, FlagSlot_0),
    /* 0x21 */ ItemFlag_SeaChartSW   = FLAG(FlagIndex_1, FlagSlot_1),
    /* 0x22 */ ItemFlag_SeaChartNW   = FLAG(FlagIndex_1, FlagSlot_2),
    /* 0x23 */ ItemFlag_SeaChartSE   = FLAG(FlagIndex_1, FlagSlot_3),
    /* 0x24 */ ItemFlag_SeaChartNE   = FLAG(FlagIndex_1, FlagSlot_4),
    /* 0x25 */ ItemFlag_PhantomSword = FLAG(FlagIndex_1, FlagSlot_5),
    /* 0x26 */ ItemFlag_SunKey       = FLAG(FlagIndex_1, FlagSlot_6),
    /* 0x27 */ ItemFlag_Unk_39       = FLAG(FlagIndex_1, FlagSlot_7),
    /* 0x28 */ ItemFlag_FishingRod   = FLAG(FlagIndex_1, FlagSlot_8),
    /* 0x29 */ ItemFlag_Cannon       = FLAG(FlagIndex_1, FlagSlot_9),
    /* 0x2a */ ItemFlag_KingsKey     = FLAG(FlagIndex_1, FlagSlot_10),
    /* 0x2b */ ItemFlag_GhostKey     = FLAG(FlagIndex_1, FlagSlot_11),
    /* 0x2c */ ItemFlag_SalvageArm   = FLAG(FlagIndex_1, FlagSlot_12),

    /* 0x2d */ ItemFlag_SwordsmansScroll = FLAG(FlagIndex_1, FlagSlot_13),
    /* 0x2e */ ItemFlag_CycloneSlate     = FLAG(FlagIndex_1, FlagSlot_14),
    /* 0x2f */ ItemFlag_BigCatchLure     = FLAG(FlagIndex_1, FlagSlot_15),

    /* 0x60 */ ItemFlag_TreasureChart1  = FLAG(FlagIndex_3, FlagSlot_0),
    /* 0x61 */ ItemFlag_TreasureChart2  = FLAG(FlagIndex_3, FlagSlot_1),
    /* 0x62 */ ItemFlag_TreasureChart3  = FLAG(FlagIndex_3, FlagSlot_2),
    /* 0x63 */ ItemFlag_TreasureChart4  = FLAG(FlagIndex_3, FlagSlot_3),
    /* 0x64 */ ItemFlag_TreasureChart5  = FLAG(FlagIndex_3, FlagSlot_4),
    /* 0x65 */ ItemFlag_TreasureChart6  = FLAG(FlagIndex_3, FlagSlot_5),
    /* 0x66 */ ItemFlag_TreasureChart7  = FLAG(FlagIndex_3, FlagSlot_6),
    /* 0x67 */ ItemFlag_TreasureChart8  = FLAG(FlagIndex_3, FlagSlot_7),
    /* 0x68 */ ItemFlag_TreasureChart9  = FLAG(FlagIndex_3, FlagSlot_8),
    /* 0x69 */ ItemFlag_TreasureChart10 = FLAG(FlagIndex_3, FlagSlot_9),
    /* 0x6a */ ItemFlag_TreasureChart11 = FLAG(FlagIndex_3, FlagSlot_10),
    /* 0x6b */ ItemFlag_TreasureChart12 = FLAG(FlagIndex_3, FlagSlot_11),
    /* 0x6c */ ItemFlag_TreasureChart13 = FLAG(FlagIndex_3, FlagSlot_12),
    /* 0x6d */ ItemFlag_TreasureChart14 = FLAG(FlagIndex_3, FlagSlot_13),
    /* 0x6e */ ItemFlag_TreasureChart15 = FLAG(FlagIndex_3, FlagSlot_14),
    /* 0x6f */ ItemFlag_TreasureChart16 = FLAG(FlagIndex_3, FlagSlot_15),
    /* 0x70 */ ItemFlag_TreasureChart17 = FLAG(FlagIndex_3, FlagSlot_16),
    /* 0x71 */ ItemFlag_TreasureChart18 = FLAG(FlagIndex_3, FlagSlot_17),
    /* 0x72 */ ItemFlag_TreasureChart19 = FLAG(FlagIndex_3, FlagSlot_18),
    /* 0x73 */ ItemFlag_TreasureChart20 = FLAG(FlagIndex_3, FlagSlot_19),
    /* 0x74 */ ItemFlag_TreasureChart21 = FLAG(FlagIndex_3, FlagSlot_20),
    /* 0x75 */ ItemFlag_TreasureChart22 = FLAG(FlagIndex_3, FlagSlot_21),
    /* 0x76 */ ItemFlag_TreasureChart23 = FLAG(FlagIndex_3, FlagSlot_22),
    /* 0x77 */ ItemFlag_TreasureChart24 = FLAG(FlagIndex_3, FlagSlot_23),
    /* 0x78 */ ItemFlag_TreasureChart25 = FLAG(FlagIndex_3, FlagSlot_24),
    /* 0x79 */ ItemFlag_TreasureChart26 = FLAG(FlagIndex_3, FlagSlot_25),
    /* 0x7a */ ItemFlag_TreasureChart27 = FLAG(FlagIndex_3, FlagSlot_26),
    /* 0x7b */ ItemFlag_TreasureChart28 = FLAG(FlagIndex_3, FlagSlot_27),
    /* 0x7c */ ItemFlag_TreasureChart29 = FLAG(FlagIndex_3, FlagSlot_28),
    /* 0x7d */ ItemFlag_TreasureChart30 = FLAG(FlagIndex_3, FlagSlot_29),
    /* 0x7e */ ItemFlag_TreasureChart31 = FLAG(FlagIndex_3, FlagSlot_30),
    /* 0x7f */ ItemFlag_TreasureChart32 = FLAG(FlagIndex_3, FlagSlot_31),
    ItemFlag_TREASURE_CHART_START       = ItemFlag_TreasureChart1,

    ItemFlag_COUNT = FLAG(FlagIndex_4, FlagSlot_0),
};
